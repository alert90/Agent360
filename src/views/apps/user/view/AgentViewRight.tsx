...
import AgentViewAccount from 'src/views/apps/user/view/AgentViewAccount'
...
const AgentViewRight = ({ tab, invoiceData }: Props) => {
  // ** State
  ...
  const handleChange = (event: SyntheticEvent, value: string) => {
    ...
    router
      .push({
        pathname: `/agents/view/${router.query.id}`,
        ...
        {isLoading ? (
          ...
          <>
            <TabPanel sx={{ p: 0 }} value='account'>
              <AgentViewAccount invoiceData={invoiceData} />
            </TabPanel>
