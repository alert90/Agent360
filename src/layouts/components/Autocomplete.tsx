  ...
  },
  {
    ...
    suggestions: [
      ...
      },
      {
        ...
        suggestion: 'Commissions',
        link: '/commission/overview'
      },
      {
...
const NoResult = ({ value, setOpenDialog }: NoResultProps) => {
  return (
    <Box sx={{ display: 'flex', alignItems: 'center', flexDirection: 'column', justifyContent: 'center' }}>
      ...
      <Typography variant='h5' sx={{ mb: 4, wordWrap: 'break-word' }}>
        No results for{' '}
                  ...
                  '& + .MuiAutocomplete-popper': {
                    ...(searchValue.length
                      ? {
                          ...
                          height: fullScreenDialog ? 'calc(100vh - 69px)' : 333,
